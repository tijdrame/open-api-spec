...
public class CategoriesApiController implements CategoriesApi {
    ...
    public ResponseEntity<List<Category>> getAllCategories(@Min(1) @Max(1000) @Parameter(in = ParameterIn.QUERY, description = "" ,schema=@Schema(allowableValues={  }, minimum="1", maximum="1000"
    ...
    public ResponseEntity<Category> getCategoryDetails(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("categoryId") Integer categoryId) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
