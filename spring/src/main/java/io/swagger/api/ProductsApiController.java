...
public class ProductsApiController implements ProductsApi {
    ...
    public ResponseEntity<List<Product>> getAllProducts(@Parameter(in = ParameterIn.QUERY, description = "" ,schema=@Schema()) @Valid @RequestParam(value = "categoryId", required = false) Integer categoryId) {
    ...
    public ResponseEntity<Product> getProductDetails(@Parameter(in = ParameterIn.PATH, description = "", required=true, schema=@Schema()) @PathVariable("productId") Integer productId) {
        String accept = request.getHeader("Accept");
        if (accept != null && accept.contains("application/json")) {
            try {
