...
@RestController
public class AnyOfOrderApiController implements AnyOfOrderApi {

    private static final Logger log = LoggerFactory.getLogger(AnyOfOrderApiController.class);
